...
return [
    ...
    //课程封面地址
    'cover_img' => 'D:/HTTP/upload_tmp_dir/course/book/',
    'view_CoverImg' => 'course/book/',//查看目录
    //课程简介图片地址
    'detail_img' => 'D:/HTTP/upload_tmp_dir/course/book/',
    'view_DetailImg' => 'course/book/',//查看目录
    //作者头像目录
    'author_img' => 'D:/HTTP/upload_tmp_dir/course/book/',
     ...
     */
    //泛读封面地址
    'extensive_cover_img' => 'D:/HTTP/upload_tmp_dir/course/question/image/extensive/',
    'view_extensive_cover_img' => 'course/question/image/extensive/',//查看目录
    //泛读视频地址
    'extensive_video' => 'D:/HTTP/upload_tmp_dir/course/question/video/extensive/',
    'view_extensive_video' => 'course/question/video/extensive/',//查看目录
    //泛读题目图片
    'extensive_topic_img' => 'D:/HTTP/upload_tmp_dir/course/question/image/',
    'view_extensive_topic_img' => 'course/question/image/',//查看目录
    //泛读题目音频
    'extensive_topic_audio' => 'D:/HTTP/upload_tmp_dir/course/question/audio/',
    'view_extensive_topic_audio' => 'course/question/audio/',//查看目录
    //泛读题目描述音频文件
    'extensive_question_des_audio' => 'D:/HTTP/upload_tmp_dir/course/question/audio/',
    'view_extensive_question_des_audio' => 'course/question/audio/',//查看目录
    //泛读题目解析音频
    'extensive_question_des_aaudio' => 'D:/HTTP/upload_tmp_dir/course/answer/audio/',
    'view_extensive_question_des_aaudio' => 'course/answer/audio/',//查看目录
    //泛读题目解析视频
    'extensive_question_des_avideo' => 'D:/HTTP/upload_tmp_dir/course/answer/video/',
    'view_extensive_question_des_avideo' => 'course/answer/video/',//查看目录
    //泛读答案图片
    'extensive_answer_image' => 'D:/HTTP/upload_tmp_dir/course/answer/image/',
    'view_extensive_answer_image' => 'course/answer/image/',//查看目录
    //泛读答案配对图片
    'extensive_answer_Pair1Img' => 'D:/HTTP/upload_tmp_dir/course/answer/image/',
