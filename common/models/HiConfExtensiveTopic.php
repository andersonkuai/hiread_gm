...
/**
 * This is the model class for table "hi_conf_extensive_topic".
 *
 * @property integer $ID
 ...
 */
class HiConfExtensiveTopic extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'hi_conf_extensive_topic';
    }
