            ...
            <div class="box">
                <div class="box-header">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a class="btn btn-default" href="?r=course/structure&type=1&id=<?=$_GET['courseId']?>"><i class="fa fa-arrow-circle-o-left"></i> <?= \Yii::t('app', '返回');?></a>
                    </div>
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($question as $val){?>
                            <tr>
                                ...
                                <td><?php echo '<b>'.$val['Min'].'</b>分<b>'.$val['Sec'].'</b>秒'?></td>
