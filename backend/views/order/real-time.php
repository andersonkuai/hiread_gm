...
<!--                        <a class="btn btn-primary" href="?r=user/add"><i class="fa fa-plus"></i> 添加</a>-->
                    ...
                    <div class="box-tools">
                        <form action="" method="get" class="form-inline">
                            <input type="hidden" name="r" value="order/real-time">
...
<!--                                <td align="center"><input type="checkbox" name="checkids[]" value="--><?php //echo $val['OrderId'];?><!--"/></td>-->
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <?php if($val['Status'] != 5) {?>
                                            <a class="btn btn-default" href="javascript:void(0)" onclick="UTILITY.OPERATE.get('?r=order/update-order&id=<?=$val['ID']?>&uid=<?=$val['Uid']?>');"><i class="fa fa-close"></i>取消</a>
                                        <?php } ?>
                                    </div>
                                </td>
                            </tr>
