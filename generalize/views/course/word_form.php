...
<section class="content-header">
    <h1>
        <?php echo empty($row) ? \Yii::t('app','添加'):\Yii::t('app','编辑')?> <?=\Yii::t('app','视频词汇')?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <a href="?r=course/word&courseId=<?=$_GET['courseId'];?>&subUnitId=<?=$_GET['subUnitId'];?>">
                <?= \Yii::t('app', '视频词汇表');?>
            </a>
        </li>
        <li class="active"><?php echo empty($row) ? \Yii::t('app','添加'):\Yii::t('app','编辑')?><?=\Yii::t('app','视频词汇')?></li>
    </ol>
</section>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="btn-group btn-group-sm" role="group">
                        <a class="btn btn-default" href="?r=course/word&courseId=<?=$_GET['courseId'];?>&subUnitId=<?=$_GET['subUnitId'];?>"><i class="fa fa-arrow-circle-o-left"></i> <?=\Yii::t('app','返回')?></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                            ...
                            <div class="col-xs-8">
                                <table style="margin-bottom: 30px">
                                    ...
                                    <tr>
                                        <td><?= \Yii::t('app', '词汇');?>：</td>
                                        <td>
                                            <input type="text" name="Word" value="<?php if(!empty($row)) echo $row['Word'];?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><?= \Yii::t('app', '分');?>：</td>
